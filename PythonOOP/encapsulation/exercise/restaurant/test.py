from encapsulation.exercise.restaurant.product import Product
from encapsulation.exercise.restaurant.beverage.beverage import Beverage
from encapsulation.exercise.restaurant.food.soup import Soup
